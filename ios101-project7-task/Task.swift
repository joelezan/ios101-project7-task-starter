...
extension Task {
    ...
    static func getTasks() -> [Task] {
        ...
        guard let savedData = UserDefaults.standard.data(forKey: "tasks") else {
                    return []
                }
    ...
    func save() {
        ...
        var tasks = Task.getTasks() // Retrieve saved tasks
                ...
                Task.save(tasks) // Save updated tasks to UserDefaults
    }
}
